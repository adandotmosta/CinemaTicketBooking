                        ...
                        return Container(
                          child: ListView(
                            ...
                            children: [
                              ...
                              _buildItem('${Constants.imagePath}${imagePaths[0]}'),
                              _buildItem('${Constants.imagePath}${imagePaths[5]}'),
                              _buildItem('${Constants.imagePath}${imagePaths[6]}'),
                            ],
                          ),
                        );
                      }
                                ...
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        '${Constants.imagePath}${castMember['profile_path']!}',
                                        fit: BoxFit.cover,
                                        width: 80,
                                        height: 80,
                                      ),
