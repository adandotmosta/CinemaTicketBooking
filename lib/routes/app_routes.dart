...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    cinemaDescriptionScreen: (context) => CinemaDescriptionScreen(),
    homeScreen: (context) => HomeScreen(),
    exploreTabContainerScreen: (context) => ExploreTabContainerScreen(),
    detailsTabContainerScreen: (context) => DetailsTabContainerScreen(),
