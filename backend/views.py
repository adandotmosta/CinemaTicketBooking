        ...
        try:
            ...
            if password == user.User_password:
                ...
                creds = {
                    ...
                    "token" : user.User_Mytoken, # user.token
                }
        ...
        for user in ticket_users:
            ...
            if fcm_token:
                ...
                fcm_device.send_message(
                    ...
                    body=f"Don't forget about the upcoming session at {session.session_time}.",
                )
